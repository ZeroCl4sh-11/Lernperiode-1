...
**28.08.2026**
## Heute
Heute habe ich meinen Random Passwort Generator angefangen und fertiggestellt. Ich habe eingebaut dass zufällige Passwörter mit Buchstaben Zahlen erstellt werden. Ich hatte ein paar Fehler und wusste nicht mehr weiter deshalb habe ich ChatGPT um Hilfe gebeten. Danach konnte ich die Fehler lösen und das Programm fertig machen.
## Nächstes Mal
Neues Projekt starten: Taschenrechner
...
**11.09.2026**
## Heute
Ich habe eine andere Idee gehabt ich habe an meinem Programm Upgradet indem ich die Maximale Passwortlänge hinzugefügt habe ich habe nicht so viel erreichen könne weil ich beim Upgrade einen Fehler hatte und ich wollte ihn wirklich selber finden ohne chat gpt. Das programmm funktioniert jetzt aber ich will mir die gleichen ziele mache wie letztes mal weil ich keine erfüllt habe.
## Nächstes Mal
